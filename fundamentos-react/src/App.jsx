...
export default () => (
  <div className="App">
    ...
    <div className="Cards">
      <Card title="#13 - Desafio Mega Sena" color="#444">
        <Megasena />
      </Card>

      <Card title="#12 - Contador" color="#444">
        <Contador numeroInicial={10}/>
      </Card>

      <Card title="#11 - Componente Controlado (Input)" color="#F90">
        <Input />
      </Card>

      <Card title="#10 - Comunicação Indireta" color="#E9967B">
        <IndiretaPai />
      </Card>
